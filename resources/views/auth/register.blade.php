<x-main_layout>
    <section class="bg-gray-50 dark:bg-gray-900 pt-32 pb-32">
        <div class="flex flex-col items-center justify-center px-6 mx-auto md:h-screen">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    @endif
                    <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" data-parsley-validate
                        method="POST">
                        @csrf
                        <div>
                            <label for="username"
                            ...
                            <input type="text" name="username" id="username" autocomplete="name"
                                ...
                                placeholder="john doe" required="" data-parsley-required="true"
                                data-parsley-trigger="change focusout"
                                data-parsley-error-message="Please enter a valid username.">
                        </div>
                        <div>
                            <label for="email"
                            ...
                            <input type="email" name="email" id="email" autocomplete="email"
                                ...
                                data-parsley-type="email" data-parsley-trigger="change focusout"
                        ...
                        <div>
                            <label for="password_confirmation"
                                ...
                                password</label>
                            <input type="password" autocomplete="off" name="password_confirmation" id="password_confirmation"
                                placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required="" data-parsley-required="true" data-parsley-equalto="#password"
                                data-parsley-trigger="change focusout"
                        ...
                        <div class="flex items-start">
                            <input id="terms" name="terms" aria-describedby="terms" type="checkbox"
                                ...
                                required="" data-parsley-required="true" data-parsley-trigger="change focusout"
