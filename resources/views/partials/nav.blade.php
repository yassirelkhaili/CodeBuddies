            ...
            <ul
                ...
                <li>
                    <a href={{ route('home.index') }}
                        class="block py-2 px-3 {{request()->routeIs('home.index') ? 'text-blue-700 dark:text-blue-500' : 'text-gray-900 dark:text-white'}} rounded md:bg-transparent md:p-0"
                        aria-current="page">Home</a>
                </li>
                <li>
                    <a href={{route('forums.index')}}
                    class="block py-2 px-3 {{request()->Is('forums*') ? 'text-blue-700 dark:text-blue-500' : 'text-gray-900 dark:text-white'}} rounded md:bg-transparent md:p-0">Forums</a>
                ...
                <li>
                    <button id="theme-toggle" type="button"
                        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mt-2 md:mt-0">
