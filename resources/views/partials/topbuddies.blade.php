    ...
    <div class="grid px-4 pb-8 lg:gap-8 xl:gap-0 lg:pb-16 lg:grid-cols-12 lg:mt-0 mt-8">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">We
                celebrate the contributions of standout members who go above and beyond in sharing knowledge, solving
            ...
            <a href={{ route('register.index') }}
                ...
                <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M6.5,12h-4a.5.5,0,0,0-.5.5V20H7V12.5A.5.5,0,0,0,6.5,12Z"/><path d="M14,4H10a.5.5,0,0,0-.5.5V20h5V4.5A.5.5,0,0,0,14,4Z"/><path d="M21.5,8h-4a.5.5,0,0,0-.5.5V20h5V8.5A.5.5,0,0,0,21.5,8Z"/></svg>
            </a>
        </div>
