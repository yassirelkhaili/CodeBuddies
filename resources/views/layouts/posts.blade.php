<div class="space-y-2 grid grid-cols-1 md:gap-3 md:space-y-0">
    @forelse ($posts as $post)
        <a href="{{ route('posts.show', $post->id) }}" class="hover:bg-gray-200 dark:hover:bg-gray-800 rounded-md hover:cursor-pointer">
            <div class="p-5">
                <div class="flex flex-row justify-between items-center mb-2">
                    <div class="flex justify-center items-center gap-2 text-blue-700 dark:text-blue-500">
